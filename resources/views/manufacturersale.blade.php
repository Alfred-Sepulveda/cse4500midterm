  ...
  <div class="card-body">
    <table id="table" class="table table-bordered">
      ...
      <tbody>
        ...
        @foreach($manufacturersales AS $manufacturersale)
        <tr>
          ...
          <td><a class="btn btn-default btn-sm" href="{{ route('manufacturers.show',['manufacturersale'=>$manufacturersale->id]) }}">View</a></td>
        </tr>
        @endforeach
