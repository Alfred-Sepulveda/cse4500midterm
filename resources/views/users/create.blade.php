...
<form method="post" action="{{ route('users.store') }}" >
    ...
    <x-adminlte-options :options="['Desktop Repair'=>'Desktop_Repair', 'Laptop Repair'=>'Laptop_Repair','Phone Repair'=>'Phone_Repair']"
        empty-option="Select a Repair Service"/></x-adminlte-select>
